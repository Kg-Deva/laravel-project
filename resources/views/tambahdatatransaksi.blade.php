...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Tambah Data Transaksi Pinjam Buku</h1>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-3" action="{{ route('simpan-data-transaksi') }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="date" name="tgl_pinjam" placeholder="dd-mm-yyyy" value=""
                                            min="1997-01-01" max="2030-12-31" required class="form-control">
                                    </div>
                                    <div class="col-md-12">
